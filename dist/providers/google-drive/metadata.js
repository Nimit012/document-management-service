...
export class DocumentMetadata {
    ...
    async setMetadata(documentId, metadata) {
        try {
            ...
            throw new ProviderError(`Failed to set metadata on document ${documentId}: ${errorMessage}`, error);
        }
    }
    /**
    ...
    async getMetadata(documentId) {
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error';
            throw new ProviderError(`Failed to get metadata for document ${documentId}: ${errorMessage}`, error);
        }
    }
    /**
