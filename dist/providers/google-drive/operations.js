...
export class DocumentOperations {
    ...
    async updateName(documentId, newName) {
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error';
            throw new ProviderError(`Failed to update document name ${documentId}: ${errorMessage}`, error);
        }
    }
    /**
    ...
    async getComments(documentId) {
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error';
            throw new ProviderError(`Failed to get comments for document ${documentId}: ${errorMessage}`, error);
        }
    }
    /**
    ...
    async getRevisions(documentId) {
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error';
            throw new ProviderError(`Failed to get revisions for document ${documentId}: ${errorMessage}`, error);
        }
    }
}
